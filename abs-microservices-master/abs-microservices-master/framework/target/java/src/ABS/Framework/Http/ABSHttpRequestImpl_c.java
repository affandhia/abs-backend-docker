...
public final class ABSHttpRequestImpl_c extends abs.backend.java.lib.runtime.ABSObject implements abs.backend.java.lib.types.ABSClass, ABS.Framework.Http.ABSHttpRequest_i {
    ...
    public final abs.backend.java.lib.types.ABSString getInput(abs.backend.java.lib.types.ABSString key) {
        ...
        if (__ABS_getRuntime().debuggingEnabled()) {
         ...
         {
            if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().nextStep("D:\\Kerja\\Thesis\\abs-microservices-framework\\src\\abs\\framework\\ABSHttpRequest.abs",0);
            if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().nextStep("D:\\Kerja\\Thesis\\abs-microservices-framework\\src\\abs\\framework\\ABSHttpRequest.abs",15);
            ...
            if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().nextStep("D:\\Kerja\\Thesis\\abs-microservices-framework\\src\\abs\\framework\\ABSHttpRequest.abs",16);
    ...
    public final abs.backend.java.lib.types.ABSString getRequestProperty(abs.backend.java.lib.types.ABSString key) {
        ...
        if (__ABS_getRuntime().debuggingEnabled()) {
         ...
         {
            if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().nextStep("D:\\Kerja\\Thesis\\abs-microservices-framework\\src\\abs\\framework\\ABSHttpRequest.abs",0);
            if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().nextStep("D:\\Kerja\\Thesis\\abs-microservices-framework\\src\\abs\\framework\\ABSHttpRequest.abs",21);
            ...
            if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().getCurrentTask().setLocalVariable("value",value);
            if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().nextStep("D:\\Kerja\\Thesis\\abs-microservices-framework\\src\\abs\\framework\\ABSHttpRequest.abs",22);
            if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().getCurrentTask().popStackFrame();
            return value;
        }
    }
