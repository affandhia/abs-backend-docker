            ...
            if (abs.backend.java.lib.expr.BinOp.notEq(DeploymentComponent_c.this.cloudprovider,null).toBoolean()) {
                 {
                    ...
                    abs.backend.java.lib.runtime.ABSFut tmp933869191 = abs.backend.java.lib.runtime.ABSRuntime.getCurrentRuntime().asyncCall(new abs.backend.java.lib.runtime.AbstractAsyncCallRT<ABS.DC.CloudProvider_i>(
                        this,
                    ...
                    ;
                    if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().getCurrentTask().setLocalVariable("tmp933869191",tmp933869191);
                    if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().nextStep("abs\\lang\\abslang.abs",929);
                    abs.backend.java.lib.runtime.ABSRuntime.await(new abs.backend.java.lib.runtime.ABSFutureGuard(tmp933869191));
                    if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().nextStep("abs\\lang\\abslang.abs",929);
                    result = (abs.backend.java.lib.types.ABSBool)tmp933869191.get();
                    if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().getCurrentTask().setLocalVariable("result", result);}
            }
            ...
            if (abs.backend.java.lib.expr.BinOp.notEq(DeploymentComponent_c.this.cloudprovider,null).toBoolean()) {
                 {
                    ...
                    abs.backend.java.lib.runtime.ABSFut tmp42783426 = abs.backend.java.lib.runtime.ABSRuntime.getCurrentRuntime().asyncCall(new abs.backend.java.lib.runtime.AbstractAsyncCallRT<ABS.DC.CloudProvider_i>(
                        this,
                        abs.backend.java.lib.runtime.ABSRuntime.checkForNull(DeploymentComponent_c.this.cloudprovider),
                        new ABS.StdLib.Duration_InfDuration(),
                        new ABS.StdLib.Duration_InfDuration(),
                    ...
                    ;
                    if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().getCurrentTask().setLocalVariable("tmp42783426",tmp42783426);
                    if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().nextStep("abs\\lang\\abslang.abs",936);
                    abs.backend.java.lib.runtime.ABSRuntime.await(new abs.backend.java.lib.runtime.ABSFutureGuard(tmp42783426));
                    if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().nextStep("abs\\lang\\abslang.abs",936);
                    result = (abs.backend.java.lib.types.ABSBool)tmp42783426.get();
                    if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().getCurrentTask().setLocalVariable("result", result);}
            }
